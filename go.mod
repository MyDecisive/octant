...
require (
	...
	github.com/MyDecisive/octant-contracts/go v0.0.0-20260429224333-78525002e2c8
...
require (
	...
	github.com/MyDecisive/octant-contracts v0.0.0-20260430204119-76b5fa16a6ff // indirect
