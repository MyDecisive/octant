...
func (_mock *MockAPI) LabelNames(ctx context.Context, matches []string, startTime time.Time, endTime time.Time, opts ...v1.Option) ([]string, v1.Warnings, error) {
...
func (_c *MockAPI_LabelNames_Call) Return(strings []string, warnings v1.Warnings, err error) *MockAPI_LabelNames_Call {
	_c.Call.Return(strings, warnings, err)
	return _c
}

func (_c *MockAPI_LabelNames_Call) RunAndReturn(run func(ctx context.Context, matches []string, startTime time.Time, endTime time.Time, opts ...v1.Option) ([]string, v1.Warnings, error)) *MockAPI_LabelNames_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockAPI) Rules(ctx context.Context) (v1.RulesResult, error) {
	ret := _mock.Called(ctx)
...
func (_c *MockAPI_Rules_Call) RunAndReturn(run func(ctx context.Context) (v1.RulesResult, error)) *MockAPI_Rules_Call {
	_c.Call.Return(run)
	return _c
}
