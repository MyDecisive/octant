...
const _DestinationName = "datadog"

var _DestinationIndex = [...]uint8{0, 7}

const _DestinationLowerName = "datadog"
...
var _DestinationValues = []Destination{DATADOG}

var _DestinationNameToValueMap = map[string]Destination{
	_DestinationName[0:7]:      DATADOG,
	_DestinationLowerName[0:7]: DATADOG,
}

var _DestinationNames = []string{
	_DestinationName[0:7],
}
