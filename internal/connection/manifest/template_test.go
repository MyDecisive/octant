...
func TestEmbeddedTemplateProvider_CoverAllTemplates(t *testing.T) {
	...
	expected := AppStrings()
	expected = append(expected, ConnectionStrings()...)
	expected = append(expected, ValidatorStrings()...)
...
func TestEmbeddedTemplateProvider_GetAllConnections(t *testing.T) {
	...
	expected := make(map[Connection][]byte)
...
func TestEmbeddedTemplateProvider_GetAllValidators(t *testing.T) {
	...
	expected := make(map[Validator][]byte)
	for _, va := range ValidatorValues() {
