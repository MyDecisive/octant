...
| --- | --- |
| Install SmartHub | SmartHub chart and Kubernetes resources. |
| Create connections | SmartHub connection resources and OpenTelemetry collectors. |
...
| Update runtime variables/settings | SmartHub runtime config and Valkey-backed state. |
